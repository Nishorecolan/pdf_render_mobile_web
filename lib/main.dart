...
class PdfRenderExample extends StatelessWidget {
  // Replace this with your actual base64 PDF data
  // final String base64String =  base64StringData; // Replace with your actual base64 PDF data
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            _showPdfViewer(context, base64String);
          },
  ...
  void _showPdfViewer(BuildContext context, String base64String) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Row(
        ...
        children: <Widget>[
          GestureDetector(
            onTap: () => controller.ready?.goToPage(pageNumber: 1),
            child: const CircleAvatar(
              child: Icon(Icons.first_page),
            ),
          ),
          GestureDetector(
            onTap: () => controller.ready?.goToPage(
                pageNumber: controller.currentPageNumber == 1
                    ? controller.currentPageNumber
                    : controller.currentPageNumber - 1),
            child: const CircleAvatar(child: Icon(Icons.navigate_before)),
          ),
          GestureDetector(
            onTap: () => controller.ready?.goToPage(
                pageNumber: controller.pageCount == controller.currentPageNumber
                    ? controller.currentPageNumber
                    : controller.currentPageNumber + 1),
            child: const CircleAvatar(child: Icon(Icons.navigate_next)),
          ),
          GestureDetector(
            onTap: () =>
                controller.ready?.goToPage(pageNumber: controller.pageCount),
            child: const CircleAvatar(child: Icon(Icons.last_page)),
          ),
        ],
      ),
    );
...
void main() {
  runApp(MaterialApp(home: PdfRenderExample()));
}
